...
def double_oracle(game, maxitr, method="DO", epsilon=1e-10):###
    ...
    for itr in range(maxitr):
        ...
        if abs(upper_bounds[-1] - lower_bounds[-1]) < epsilon:##
            break
